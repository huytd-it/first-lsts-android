...
myApp.controllers = {
  ...
  tabbarPage: function(page) {
    ...
    //page.querySelector('#myTabbar').setAttribute('animation', ons.platform.isAndroid() ? 'slide' : 'slide');

    page.querySelector('#myTabbar').setAttribute('animation','slide');
